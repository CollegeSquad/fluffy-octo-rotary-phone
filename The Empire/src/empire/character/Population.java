...
public class Population {
	/**
	 * need a base level of max population and a current level of max population
	 * that can be upgradeable
	 */
	...
	/**
	 * 
	 * Each of the subclasses of citizen could have some sort of "upgrade" path
	 * where they can offer different services or end up paying more rent.
	 *
	 */
